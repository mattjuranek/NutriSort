...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v2.0.0-RC2"
  WORKING_DIRECTORY "/Users/matthewjuranek/Project3DSA/cmake-build-debug/_deps/zlib-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"v2.0.0-RC2\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/matthewjuranek/Project3DSA/cmake-build-debug/_deps/zlib-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/matthewjuranek/Project3DSA/cmake-build-debug/_deps/zlib-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
